...
if __name__ == "__main__":
    ...
    ref_path = '/data2/zhangjunchao/workspace/MIPLTest/Caption/caption_eval/reference_videos_MSRVTT_YMKselected.json'; 
    res_path = '/home/zhangjunchao/workspace/MIPLProject/Test/Caption/captioning_results.json'
