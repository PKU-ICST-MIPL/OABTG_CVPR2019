...
class SoftModel():
	...
	def __init__(self, video_feature, obj_feature, input_captions, voc_size, d_w2v, output_dim, 
		...
		print('SamModel_ObjectV_att_NoShare.py: __init__: obj_feature:', obj_feature.get_shape().as_list())
		...
		print('SamModel_ObjectV_att_NoShare.py: __init__: video_feature:', video_feature.get_shape().as_list())
		...
		print('SamModel_ObjectV_att_NoShare.py: __init__: self.enc_in_shape_video:', self.enc_in_shape_video,
	...
	def init_embedding_matrix(self):
		...
		#print('SamModel_ObjectV_att_NoShare.py: init_embedding_matrix starts ...')
		voc_size = self.voc_size # 12597
		d_w2v = self.d_w2v	# 512
		print('SamModel_ObjectV_att_NoShare.py: init_embedding_matrix: voc_size=', voc_size, 'd_w2v=', d_w2v)
		...
		print('SamModel_ObjectV_att_NoShare.py: init_embedding_matrix: T_mask:',T_mask.get_shape().as_list())
		...
		print('SamModel_ObjectV_att_NoShare.py: init_embedding_matrix: T_w2v:',T_w2v.get_shape().as_list())
		#print('SamModel_ObjectV_att_NoShare.py: init_embedding_matrix ends ...')
		return T_w2v, T_mask 
	...
	def encoder(self, input_feature): ### for video feature
		...
		print('SamModel_ObjectV_att_NoShare.py: encoder: assignment:', assignment)
		axis = [1,0]+list(range(2,5)) 
	...
	def encoder_allobjs(self, input_feature): ### for object feature
		...
		print('SamModel_ObjectV_att_NoShare.py: encoder_allobjs: assignment:', assignment)
		axis = [1,0]+list(range(2,5)) 
	...
	def beamSearchDecoder_objV_att(self, initial_state, input_feature, o_input_feature):
		...
		def step(x_t,h_tm1):
			...
			print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: step: input_feature:', input_feature, 'o_input_feature:', o_input_feature)
		...
		def take_step_zero(x_0, h_0):
			...
			print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: take_step_zero: past_logprobs:', past_logprobs.get_shape().as_list(),
		...
		def test_step(time, x_t, h_tm1, past_symbols, past_logprobs, finished_beams, logprobs_finished_beams):
			...
			print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: test_step: beam_past_symbols:', beam_past_symbols.get_shape().as_list())
			...
			print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: test_step: past_symbols:', past_symbols.get_shape().as_list())
			...
			#print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: test_step: cond1:', cond1.get_shape().as_list(), cond1)

			for_finished_logprobs = tf.where(cond1,past_logprobs,tf.ones_like(past_logprobs,tf.float32)* -1e5) # shape [1, beam_size]
			#print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: test_step: for_finished_logprobs:', for_finished_logprobs)
			...
			#print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: test_step: done_indice_max:', done_indice_max, 'logprobs_done_max:', logprobs_done_max)
			...
			#print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: test_step: cond2:',cond2, 'cond3:',cond3, 'cond4:',cond4)
			...
			print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: test_step: symbols:',symbols, 'h:',h)
			print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: test_step: past_symbols:',past_symbols, 'past_logprobs:',past_logprobs)
			print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: test_step: finished_beams:',finished_beams, 
		...
		print('SamModel_ObjectV_att_NoShare.py: beamSearchDecoder: after take_step_zero, symbols:',symbols,
	...
	def build_model(self):
		...
		#print('SamModel_ObjectV_att_NoShare.py: build_model: input_feature:', input_feature.get_shape().as_list())
		...
		print('SamModel_ObjectV_att_NoShare.py: build_model: after encoder, last_output:', last_output.get_shape().as_list())
		print('SamModel_ObjectV_att_NoShare.py: build_model: v_encoder_output:', v_encoder_output.get_shape().as_list(),
		...
		#predict_words: shape [batch, caplen], for test hidden_states
		#loss_mask: shape [batch, caplen], float32, the float version of mask (bool)
		print('SamModel_ObjectV_att_NoShare.py: build_model: after decoder, predict_score:', predict_score.get_shape().as_list(),
		...
		print('SamModel_ObjectV_att_NoShare.py: build_model: after beamSearchDecoder, finished_beam:', finished_beam.get_shape().as_list(),
